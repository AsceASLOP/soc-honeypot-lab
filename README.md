...
- Created a workspace log analytics workspace, connected it to Microsoft Sentinel, configured the connector for "Windows Security Events via AMA", 
- Created Data collection rule within sentinel
